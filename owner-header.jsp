...
<header class="site-navbar">
    <div class="container d-flex justify-content-between align-items-center">
        <!-- Logo -->
        <div class="site-logo">
            <a href="owner-dashboard.jsp">CarRent</a>
        </div>
        ...
        <nav class="site-navigation">
            <ul class="site-menu d-flex align-items-center">
                ...
                <li><a href="my-cars.jsp">My Cars</a></li>
                <li><a href="owner-bookings.jsp">Bookings</a></li>
                <li><a href="profile-settings.jsp">Profile</a></li>
