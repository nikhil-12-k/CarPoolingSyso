...
<div class="container mt-5">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body">
            ...
            <div class="row mb-2">
                <div class="col-md-6"><strong>Owner Name:</strong> <%= ride.getOwnerName() %></div>
                <div class="col-md-6"><strong>Registration No:</strong> <%= ride.getRegistrationNumber() %></div>
            </div>
            <div class="row mb-2">
    ...
    <div class="d-flex gap-3">
        ...
        <a href="bookRide.jsp" class="btn btn-success">Book Another Ride</a>
